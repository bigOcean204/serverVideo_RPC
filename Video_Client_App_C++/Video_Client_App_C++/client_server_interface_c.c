...
static const RPC_CLIENT_INTERFACE client_server_http___RpcClientInterface =
    {
...
RPC_IF_HANDLE client_server_http_v1_0_c_ifspec = (RPC_IF_HANDLE)& client_server_http___RpcClientInterface;
#ifdef __cplusplus
namespace {
#endif
...
static RPC_BINDING_HANDLE client_server_http__MIDL_AutoBindHandle;
    ...
    /* [out] */ unsigned char *isSuccess)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&client_server_http_StubDesc,
                  (PFORMAT_STRING) &client_server_interface__MIDL_ProcFormatString.Format[0],
                  hBinding,
                  pszFile,
                  isSuccess);
    ...
    /* [out] */ unsigned char *isSuccess)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&client_server_http_StubDesc,
                  (PFORMAT_STRING) &client_server_interface__MIDL_ProcFormatString.Format[42],
                  hBinding,
                  start,
                  end,
                  isSuccess);
    ...
    /* [out] */ unsigned char *isSuccess)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&client_server_http_StubDesc,
                  (PFORMAT_STRING) &client_server_interface__MIDL_ProcFormatString.Format[90],
                  hBinding,
                  pszFile1,
                  pszFile2,
                  isSuccess);
    ...
    /* [out] */ unsigned char *pszFile)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&client_server_http_StubDesc,
                  (PFORMAT_STRING) &client_server_interface__MIDL_ProcFormatString.Format[138],
                  hBinding,
                  pszFile);
...
static const MIDL_STUB_DESC client_server_http_StubDesc = 
    {
    (void *)& client_server_http___RpcClientInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    &client_server_http__MIDL_AutoBindHandle,
    0,
    0,
    0,
    0,
